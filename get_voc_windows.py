...
"""
从网盘下载VOC数据集：链接：https://pan.baidu.com/s/1RztRLwk3Dye9qkmXxG40JA 提取码：e2q0
VOCtrainval_06-Nov-2007.tar
VOCtrainval_11-May-2012.tar
VOCtest_06-Nov-2007.tar
get_voc_windows.py

将VOC数据集解压，然后执行该文件：python get_voc_windows.py
